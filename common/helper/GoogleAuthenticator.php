...
class GoogleAuthenticator
{
    ...
    /**
     * random alphanumeric number generator
     *
     * @return bool|string
     */
    ...
    /**
     * create current month+date string
     *
     * @return false|string
     */
    ...
    /**
     * generate unique key consist of alphanumeric with month and date string
     *
     * @return string
     */
     ...
     * @return array
     */
    public static function generateDefaultCode()
    {
        $DEFAULT_CODE_NUM = 6;
        $codes = [];

        for($i = 0; $i<$DEFAULT_CODE_NUM; $i++){
            $num_str = sprintf('%06d', mt_rand(1, 999999));
            array_push($codes, $num_str);
        }
